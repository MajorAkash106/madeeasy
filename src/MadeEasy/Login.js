            ...
            <Container>
                ...
                <View style={styles.welcome}>
                    ...
                    <TouchableOpacity onPress={()=>Actions.forgot_password()}>
                        <Text style={{ color: "#E60E0F", fontSize: 15, marginTop: 10, textDecorationLine: 'underline', textDecorationStyle: 'solid' }}>Forgot Password?</Text>
                    </TouchableOpacity>
                    {/* </View> */}

                    <Button onPress={()=>Actions.feedback_suggestion()} style={{ backgroundColor: '#E60E0F', borderRadius: 10, height: 40, width: 150, justifyContent: 'center', marginTop: 10 }}>
                        <Text style={iOSUIKit.bodyEmphasizedWhite}>SIGN IN</Text>
                    </Button>
                    ...
                    <View style={styles.view}>
                        ...
                        <TouchableOpacity onPress={()=>Actions.signup()} >
                            <Text style={{ textAlign: "center", color: "#E60E0F", fontSize: 15, textDecorationLine: 'underline' }}>Sign Up Now</Text>
                        </TouchableOpacity>
                    </View>
